...
def generateFigure(G, pos, color_map):
    ...
    return fig
def generateFigure_uGraph(G, pos, color_map):
    ...
    colors = [G[u][v]['color'] for u,v in edges]
    nx.draw_networkx_edges(G, pos, edgelist=G.edges, edge_color =colors,arrowsize=20, width=2)
